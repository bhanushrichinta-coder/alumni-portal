...
import SuperAdminPasswordResets from '@/components/superadmin/SuperAdminPasswordResets';

const SuperAdminPasswordsPage = () => {
        ...
        <div className="sticky top-0 z-20 bg-card/95 backdrop-blur-sm border-b border-border shadow-sm">
          <div className="w-full px-3 sm:px-4 lg:px-6 py-4">
            <div className="max-w-7xl mx-auto flex items-center gap-3">
              ...
              <h1 className="text-xl sm:text-2xl font-bold">Password Reset Requests</h1>
            </div>
          </div>
        </div>
        <div className="w-full px-3 sm:px-4 lg:px-6 py-6">
          <div className="max-w-7xl mx-auto">
            <SuperAdminPasswordResets />
          </div>
        </div>
      </main>
      <MobileNav />
...
export default SuperAdminPasswordsPage;
